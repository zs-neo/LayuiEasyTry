...
<form class="layui-form" action="" method="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="dept_code" style="width:200px;" autocomplete="off" value="<%=dept_code%>"
                   class="layui-input">
        </div>
    </div>
    <%
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="dept_name" style="width:200px;" autocomplete="off" value="<%=dept_name%>"
                   class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="dept_catagory" style="width:200px;" autocomplete="off" value="<%=dept_catagory%>"
                   class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="dept_type" style="width:200px;" autocomplete="off" value="<%=dept_type%>"
                   class="layui-input">
        </div>
    </div>
        ...
        form.on('submit(demo1)', function (data) {
            $.ajax({
                ...
                data: {
                    'oid': data.field.oid,
                    'id': data.field.id,
                    'dept_code': data.field.dept_code,
                    'dept_type': data.field.dept_type,
                    'dept_name': data.field.dept_name,
                    'dept_catagory': data.field.dept_catagory
                },
